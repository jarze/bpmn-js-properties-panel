...
export default function FormField(props) {
  const { idPrefix, formField } = props;
...
function Type(props) {
  const { idPrefix, element, formField } = props;
...
function Value(props) {
  const { element, id: idPrefix, index, item: value, open } = props;
...
function ValueList(props) {
  const { element, formField, idPrefix } = props;
  ...
  return (
    <ListEntry
      element={element}
      autoFocusEntry={`[data-entry-id="${id}-value-${
        values.length - 1
      }"] input`}
      id={id}
...
function Constraint(props) {
  const { element, id: idPrefix, index, item: constraint, open } = props;
...
function ConstraintList(props) {
  ...
  return (
    <ListEntry
      element={element}
      autoFocusEntry={`[data-entry-id="${id}-constraint-${
...
function Property(props) {
  const { element, id: idPrefix, index, item: property, open } = props;
